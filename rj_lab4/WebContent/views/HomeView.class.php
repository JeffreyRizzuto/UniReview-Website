...
class HomeView {
	...
	<br><br>
	<p>Valid Test User - Username: theflash password: speedster</p>
	<br><br>
	<a href="/rj_lab4/tests/ShowAllUsers_Tests.php">Show All Users</a>
	<a href="/rj_lab4/tests/ShowAllArticles.php">Show All Articles</a>
	<a href="/rj_lab4/create">Create Article</a>
	<aside></aside>
<?php
	}
}